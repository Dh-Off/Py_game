...
import pygame
from pygame.locals import QUIT, Rect, KEYDOWN, K_SPACE, K_UP, K_DOWN, K_RIGHT, K_LEFT
...
def main():
    ...
    ship_image = pygame.image.load("C:/Users/온동헌/Desktop/pythonwork/겜프/동굴/ship.png")
    bang_image = pygame.image.load("C:/Users/온동헌/Desktop/pythonwork/겜프/동굴/bang.png")
    holes = []
